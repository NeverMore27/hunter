...
hunter_config(benchmark VERSION 1.2.0)
hunter_config(bison VERSION 3.0.4)
...
hunter_config(dlib VERSION 19.6-p1)
...
hunter_config(gauze VERSION 0.1.2)
...
hunter_config(gRPC VERSION 1.6.6)
...
hunter_config(ogles_gpgpu VERSION 0.2.5)
hunter_config(onmt VERSION 0.4.1-p2)
hunter_config(openddlparser VERSION 0.1.0-p2)
hunter_config(opentracing-cpp VERSION 1.0.0)
...
hunter_config(thrift VERSION 0.10.0-p1)
...
hunter_config(avl_tree VERSION 0.1.0.0)
